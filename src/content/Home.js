            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width:"24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Swimming Pool</h5>
                                <p className="card-text text">we humans have to learn how to keep our bodies afloat and move in water. But knowing how
                                    to
                    ...
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width:"24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Smart Class</h5>
                                <p className="card-text text">What is Smartclass? The advent of information technology in education has changed its scenario
                    ...
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width:"24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Transport</h5>
                                <p className="card-text text">Evergreen Public School has an excellent maruti vans with stops at regular intervals for
                    ...
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width:"24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Indoor and Outdoor games</h5>
                                <p className="card-text text">Sports in the institution play a central role in preparing the students to be
                    ...
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width:"24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Computer lab</h5>
                                <p className="card-text text">The School has a very good computer lab having 25 computers with LCD projector to provide
                    ...
                    <div className="col-12 col-sm-4">
                        <div className="card text-center main-card" style={{width: "24rem"}}>
                            <div className="card-body">
                                <h5 className="card-title title">Canteen-The Healthy Zone </h5>
                                <p className="card-text text">In keeping with our school’s aim of providing all-round development and care, we provide
                ...
                <div className="row">
                    ...
                    <div className="col-sm-5">
                        <div className="card pic">
                            <img className="card-img-top in-pics" src={Praveen} alt="Card image cap" />
                            <div className="card-body">
                                <h5 className="card-title" style={{marginLeft:"5px"}}>Managing Director </h5>
                                <p className="card-text main-text text-justify"><b>"Education is the most powerful weapon which you can use to change the world"— Nelson Mandela.</b>
                    ...
                    <div className="col-sm-5">
                        <div className="card pic">
                            <img className="card-img-top in-pics" src={Founder} alt="Card image cap" />
                            <div className="card-body">
                                <h5 className="card-title"  style={{marginLeft:"5px"}}>Principal</h5>
                                <p className="card-text main-text text-justify">Dear Students, Staff and Parents:
